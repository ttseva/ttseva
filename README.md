...
(rest на период сессии)



Фронтенд-разработчик и студент 3 курса технического вуза.

<br>

— Основа стека состоит из: `HTML/CSS`, `JavaScript`, `React`, `Redux Toolkit`\
— А также: `Английский С1`, `Технический английский В2`, `Docker`\

👾 Параллельно пробуюсь в языке Golang с перспективой в fullstack-разработку.
...
anastasiaspesivtseva<!-- -->@<!-- -->yandex.ru

> Заметка! В учебных проектах от GLO требовалось работать только с логикой: вёрстка и ресурсы были уже предоставлены.
